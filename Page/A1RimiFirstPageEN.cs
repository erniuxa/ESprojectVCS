...
{
    public class A1RimiFirstPageEN : BasePage
    {
        private const string PageAddress = "https://www.rimi.lt/e-parduotuve/en";
        ...
        public A1RimiFirstPageEN(IWebDriver webdriver) : base(webdriver)
        { }
        public A1RimiFirstPageEN NavigateToPage()
        {
        ...
        public A1RimiFirstPageEN AcceptAllConsents()
        {
